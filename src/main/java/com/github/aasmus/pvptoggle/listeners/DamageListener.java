...
public class DamageListener implements Listener {
    ...
    public void onHit(EntityDamageByEntityEvent event) {
        ...
        } else if (event.getDamager() instanceof LightningStrike && !event.getDamager().getMetadata("TRIDENT").isEmpty() &&
    ...
    public void onPlayerFishing(PlayerFishEvent event) {
        ...
        if (event.getCaught() instanceof Player) {
            ...
            if (damager.getInventory().getItemInMainHand().getType() == Material.FISHING_ROD ||
                    damager.getInventory().getItemInOffHand().getType() == Material.FISHING_ROD) {
                if (damagerState) {
                    event.setCancelled(true);
                    Chat.send(damager, "PVP_DISABLED");
                } else if (attackedState != null && attackedState) {
